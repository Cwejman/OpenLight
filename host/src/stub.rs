...
//! `subscribe`/`unsubscribe`) per `@md/spec/substrate.md` §Queries/Scoping and
//! `@md/spec/engine.md` §The Program Protocol; result shapes mirror
//! `@md/spec/sdk.md` §Types. Ops that need the real engine (writes, runs)

...
- **`seq: true` on projected archetypes.** `db/commits` is projection-backed and programs.md treats it as an ordered place, but a projected archetype cannot carry a stored flag.

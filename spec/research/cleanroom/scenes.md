...
Everything here sits strictly on [`substrate.md`](../../substrate.md), [`engine.md`](../../engine.md), [`host.md`](../../host.md), and [`sdk.md`](../../sdk.md). Where a scene needs something those specs do not hold, it appears in *Demands* (D1–D13) rather than being silently assumed.

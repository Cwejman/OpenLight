...
The first-party UI primitives already include compositions of programs (see `spec/host.md` — `ui/recipe`, the spawned-composition concept, the tile tree). A composition of programs **is** an island system, just at a coarser primitive: the program.

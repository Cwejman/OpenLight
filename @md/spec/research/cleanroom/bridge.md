...
The program layer of OpenLight. The four mechanism specs ([`substrate.md`](../../substrate.md), [`engine.md`](../../engine.md), [`host.md`](../../host.md), [`sdk.md`](../../sdk.md)) are taken as given; this document derives the program set that makes their central claim real: **a model-calling program is a citizen like any other.** Human, classical program, and model share one typed, versioned medium — same reads, same commits, same surfaces, same audit trail.

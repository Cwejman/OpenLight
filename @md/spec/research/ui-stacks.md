...
- **Distinct.** Coherent native creative-computing stack in a modern systems language. `mach-sysjs` integrates with JS cleanly on web targets. Aligns with spec/pilot.md's post-pilot Zig-substrate direction.

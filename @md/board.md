...
2. **The knowledge-angle turnovers** — siblings, no order among them: **the code stands rewritten from its essence** — with the author in-session (2026-08-28), at [`spec/research/knowledge/code.md`](spec/research/knowledge/code.md): why → limit → fold and link → two laws → open; medium-agnostic, awaiting the author's ratification word · **the first proof** — the markdown-directory companion piece the code's empty link points at: how a link is written, how confidence is marked, how a structure is stewarded day to day · **the research re-derivation** — first pass stands (2026-08-29): [`findings/`](spec/research/sweep-2026-08/findings/README.md) (categorical, for decisions) and [`encounters.md`](spec/research/sweep-2026-08/encounters.md) (narrative, for engagement), with [`method.md`](spec/research/sweep-2026-08/method.md) as the chain of custody — awaiting the author's read; evidence.md is retired to git (framed by the superseded six rules, its stewarding context lost) and feedback.md retired as served; [`spec/research/landscape.md`](spec/research/landscape.md) is kept as ore, to be re-read critically rather than trusted · **conventions.md** (grown steward-driven; its knowledge section is what the code supersedes on ratification; the rest still owed the README treatment) · **this board** (keep it pure state) · **the register pass** over the spec tree (author direction, 2026-08-22: each file re-shaped why-first; the code, once ratified, is its instrument — not this cycle's work). The arc's record lives in [`spec/research/knowledge/opening.md`](spec/research/knowledge/opening.md).

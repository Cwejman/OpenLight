...
2. **The knowledge arc** — the live edition is lab 10's ([`code.md`](spec/research/knowledge/code.md)), rewritten with the author 2026-09-10/11 and ahead of [the edition of 2026-08-30](spec/research/knowledge/study/code-2026-08-30.md) (2026-08-30) by a generation; lab 10's corpus stands after five rounds, its piece is next, then the author's cold read. Owed beside it: the author's cold read of lab 10's piece, the author's personal note the edition links, and the grounds. One program stands beside the study, [the reader](spec/research/knowledge/study/reader/README.md), whose briefs are now its specification; its [order of work](spec/research/knowledge/study/reader/forward.md) is the distance between that and what runs, and opens with the author's verdict that it is hard to use. The surface built beside it was retired 2026-09-12; [the surface](spec/research/knowledge/poc/surface/README.md) took its second reading model on 2026-09-13, one lane with the sides orienting, specified and built in one sitting and awaiting the author's use. The ratified code the search's working state — focus, claims under test, evidence, method — lives in [`study/`](spec/research/knowledge/study/README.md), and the arc's served records (opening, the two derivations, the tree survey) are retired to git. Next in the arc, in order: **labs on the sweep corpus** — the claims tried on easy ground first (the study holds the claims and the tests) — then **the first proof** — the markdown-directory piece the code's empty link points at, deliberately unwritten until it can be harvested from what the labs settle — then **the spec/ rewrite under code + proof** (this absorbs the register pass; the arc's finish line). Still awaiting the author's read: the two existing lab readings ([`01-categorical/`](spec/research/knowledge/study/01-categorical/output/README.md), [`02-encounters/`](spec/research/knowledge/study/02-encounters/output.md)) and the sweep's [`method.md`](spec/research/knowledge/study/sweep-2026-08/method.md); [`landscape.md`](spec/research/landscape.md) kept as ore. Standing beside: conventions.md's remaining turnover (its knowledge section is superseded and points at the code; the rest still owed the README treatment) · this board (keep it pure state).

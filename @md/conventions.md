...
Superseded (2026-08-30). The principle this section sought is found: [the code](spec/research/knowledge/code.md), ratified 2026-08-30 and carried forward by the labs since. The search continues beside it in [`spec/research/knowledge/study/README.md`](spec/research/knowledge/study/README.md) — the claims under test, their evidence, the method. This section's prior content is retired to git.
